  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-lg">
        <div
          ...
          style={{
            ...
            filter: isScaled
              ? "brightness(90%) sepia(100%) saturate(100%) hue-rotate(10deg)"
              : "none",
          }}
        ></div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-2">
        ...
        <p className="leading-normal text-white text-lg py-3">{subheading}</p>
      </div>
    </div>
  );
};
    ...
    <div className="mx-auto max-w-[1360px] my-20 lg:my-32 px-10 lg:px-6 relative">
      <div className="mb-12">
        ...
        >
          ...
          >
            Experience the convergence of cutting-edge technology and expert
            craftsmanship with Conrads Consult & Engineering&apos;s innovative
            product solutions.
          </motion.p>
        </motion.div>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-16 lg:mt-24">
        {productdata.map((items, index) => (
          <Link className="space-y-8" href="/products" key={index}>
            <ProductsCard
