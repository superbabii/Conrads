...
const Footer = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-2xl lg:mt-16 lg:mt-32 pb-16 px-4 sm:px-6 lg:max-w-[1360px] lg:px-8">
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className="group relative col-span-3">
            <p className="text-white text-xl font-medium mb-9">{t("Links")}</p>
            <ul>
              {Links.map((item, index) => (
                <li key={index} className="mb-5">
                  <Link
                    href={item.href}
                    className="text-maingray text-sm font-normal mb-6 space-links"
                  >
                    {t(item.name)}
                  </Link>
                </li>
          ...
          <div className="col-span-3">
            ...
            <h4
              className="text-maingray text-sm font-normal mb-6 flex gap-2"
              style={{ alignItems: "flex-start" }}
            >
              <HomeIcon style={{ verticalAlign: "top", color: "white" }} />
              <span>
                Münderhäuser Straße 31,
                <br />
            ...
            <h4 className="text-maingray text-sm font-normal mb-6 flex gap-2">
              ...
              <a
                className="contact-obj"
                href="tel:+49-662-343-645-10"
            ...
            <h4 className="text-maingray text-sm font-normal mb-6 flex gap-2">
              ...
              <a
                className="contact-obj"
                href="mailto:info@conrads-engineering.com"
                style={{ textDecoration: "none" }}
              >
