      ...
      <div className="mx-auto max-w-[1360px] px-4 sm:py-4 lg:px-8 text-maingray text-lg my-12">
        ...
        <div className="flex gap-x-4">
          ...
          <span>
            ...
            36199 Rotenburg an der Fulda, <br /> Germany
          </span>
        </div>
        <div className="flex gap-x-4">
        ...
        <div className="inline-block">
          <span>
            Website developed with Next.js by Nazar Babii and Conrads Consult &
            Engineering.
          </span>
        </div>
        <br />
        ...
        <div className="text-lg">
          Copyright © {new Date().getFullYear()} Conrads Consult & Engineering.
          All rights reserved.
        </div>
        <br />
        <h2 className="text-white text-2xl lg:text-4xl mb-3">
