...
const contacts = [
  ...
  },
  {
    ...
    content: (
      <a
        className="text-white font-normal text-center transition-colors duration-300 hover:text-[#710010]"
  ...
  },
  {
    icon: (
      <AccessTimeFilledIcon
        style={{ color: "#710010", width: 80, height: 80 }}
      />
    ),
    title: "Office Hours",
    content: (
    ...
    <Layout>
      ...
      >
        {contacts.map((contact, index) => (
          ...
          >
            <div className="flex justify-center p-3">{contact.icon}</div>
              ...
              <div className="-mx-4">
                ...
                <div className="w-full px-4">
                  <div className="mb-8">
                    ...
                    >
                      <option value="" className="text-graywhite">
                        Select a subject
                      </option>
                      <option
                      ...
                      <option value="Feedback" className="text-graywhite">
                        Feedback
                      </option>
                      <option
